...
I used the Diabetes prediction dataset from Kaggle to build a diabetes prediction model, package it as an API, containerize it with Docker, and deployed it to Azure Container Apps.
...
This project uses the **Diabetes prediction dataset** dataset to predict whether a person is diabetic (`Diabetes_binary = 1`) based on lifestyle, health, and demographic factors.
...
3. Save the file as: diabetes.csv
